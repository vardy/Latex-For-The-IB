...
For example, this document uses the following setup:
\begin{verbatim}
    \documentclass[12pt,a4paper]{article}
\end{verbatim}
This means it's written as an article, default font size is 12\,pt and size of the paper is a4. Since there is no orientation specified, portrait is used by default.
